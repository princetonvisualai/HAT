...
data_root = 'data/rnp/rawframes'
data_root_val = 'data/rnp/rawframes'
ann_file_train = 'data/rnp/rnp_val_list_rawframes.txt'
ann_file_val = 'data/rnp/rnp_val_list_rawframes.txt'
ann_file_test = 'data/rnp/rnp_val_list_rawframes.txt'
