...
data_root = 'data/kinetics_inpainting/rawframes_val'
data_root_val = 'data/kinetics_inpainting/rawframes_val'
ann_file_train = 'data/kinetics400/kinetics400_train_list_rawframes.txt'
ann_file_val = 'data/kinetics_inpainting/kinetics400_val_list_rawframes.txt'
ann_file_test = 'data/kinetics_inpainting/kinetics400_val_list_rawframes.txt'
